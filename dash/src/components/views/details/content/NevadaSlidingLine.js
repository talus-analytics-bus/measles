...
class NevadaSlidingLine extends Chart {
  ...
  draw() {
    ...
    chart
      ...
      .on('mousemove', function tooltipLineUpdate() {
        ...
        const items = []
        const curDatumArr = [yDatum]
        curDatumArr.forEach(itemDatum => {
    ...
    chart.update = metric => {
      ...
      // Create new chart
      const newSlidingLineChart = new NevadaSlidingLine(
...
export default NevadaSlidingLine
