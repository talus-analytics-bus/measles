...
const About = () => {
  ...
  return (
    ...
    <p>Available caseload data report the number of cases per country, per month. An outbreak is indicated as &ldquo;increasing&rdquo; if the number of cases in the most recent month for which data are available is greater than the number of cases in the prior month. The percent change in cases from month to month is calculated as the difference in the total number of cases between the current month and the prior month, divided by the total number of cases in the prior month.</p>
