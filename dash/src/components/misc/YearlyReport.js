  ...
  const yearlyReportData = {
    'caseload_totalpop': {
      'VE': {
        ...
        data_source: 'WHO Measles Surveillance Data as of Oct 2019',
      },
    },
    'incidence_yearly': {
      'VE': {
        values: [{"value":15.74564078,"year":2019},
        ...
        {"value":0,"year":2011}],
        data_source: 'WHO Measles Surveillance Data and UN World Population Prospects as of Sep 2019',
      },
    },
  }
  const paramName = props.metric === 'caseload_totalpop' ? 'caseload_totalpop'
    : 'incidence_yearly';
